  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-zinc-950 overflow-hidden font-sans py-10">
      ...
      <motion.div
        ...
        className="relative z-10 w-full max-w-lg p-8 mx-4 bg-slate-800/80 backdrop-blur-xl border border-slate-700 rounded-2xl shadow-2xl"
      >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          {error && (
            <div className="p-3 text-sm text-red-400 bg-red-900/30 border border-red-800 rounded-lg text-center">
              {error}
            </div>
          )}
          ...
          {/* Passwords Side-by-Side with Toggle */}
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-300 mb-1">
                Password
              ...
              <div className="relative">
                <input
                  ...
                  required
                  className="w-full pl-4 pr-10 py-2.5 bg-slate-900/50 border border-slate-600 rounded-lg text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            <button
              type="button"
              className="group flex items-center justify-center gap-3 w-full px-4 py-2 bg-slate-900/40 border border-slate-600 rounded-lg hover:bg-slate-800 transition-colors duration-300"
            >
              <svg
