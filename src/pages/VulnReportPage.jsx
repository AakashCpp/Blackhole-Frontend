...
const SCAN_DATA = {
  ...
  vulnerabilities: [
    ...
    },
    {
      ...
      url: "https://example.com/sitemap.xml",
      description:
        "The content was retrieved from a shared cache. If the response data is sensitive, personal or user-specific, this may result in sensitive information being leaked.",
      solution:
        "Validate that the response does not contain sensitive, personal or user-specific information. Consider using Cache-Control: no-cache.",
      reference: "",
      cweid: "525",
    },
    {
      ...
      solution:
        "Validate that the response does not contain sensitive information.",
      reference: "",
      cweid: "525",
    },
    {
      ...
      solution:
        "Ensure that your web server is configured to enforce Strict-Transport-Security.",
      reference:
    ...
    },
    {
      ...
      url: "https://example.com",
      description:
        "The cache-control header has not been set properly or is missing.",
      solution:
    ...
    },
    {
      ...
      description:
        "Content Security Policy (CSP) is an added layer of security that helps to detect and mitigate certain types of attacks.",
      solution:
        "Ensure that your web server is configured to set the Content-Security-Policy header.",
      reference: "",
      cweid: "693",
    },
    {
    ...
    },
    {
      ...
      solution:
        "Ensure that the application/web server sets the X-Content-Type-Options header to 'nosniff'.",
    ...
    },
    {
      ...
      url: "https://example.com",
      description:
        "Content which was initially accessed via HTTPS is also accessible via HTTP.",
      solution:
        "Ensure that your web server is configured to only serve such content via HTTPS.",
      reference: "",
      cweid: "311",
    },
  ],
